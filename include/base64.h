...
namespace small {
    ...
    inline T tobase64(const unsigned char *src, const std::size_t src_length)
    {
        ...
        // encode
        base64impl::tobase64(reinterpret_cast<unsigned char *>(base64.data()), src, src_length);
    ...
    {
        return tobase64<T>(reinterpret_cast<const unsigned char *>(src), src_length);
    }
    ...
    {
        return tobase64<T>(reinterpret_cast<const unsigned char *>(v.data()), v.size());
    }
    ...
    inline T frombase64(const unsigned char *base64, const std::size_t base64_length)
    {
        ...
        // decode
        std::size_t decoded_length = base64impl::frombase64(reinterpret_cast<unsigned char *>(decoded.data()), base64, base64_length);
    ...
    {
        return frombase64<T>(reinterpret_cast<const unsigned char *>(base64), base64_length);
    }
    ...
    {
        return frombase64<T>(reinterpret_cast<const unsigned char *>(base64.data()), base64.size());
    }
